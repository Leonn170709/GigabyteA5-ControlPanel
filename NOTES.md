...
## Assets
- `panel.py` (PyQt6 GUI, works headless), `laptop-control-helper` (monitor/set-tdp),
  ...
  `probe-out/` (dsdt.dsl + EC dumps, generated by probe.sh, not committed), install.sh,
  README.md, test_panel.py.
- Build module: `make -C kmod` (autodetects clang vs gcc kernels).
- Access harness: `sudo ./labctl {wmb|dsm|modload|modunload|memread|memwrite|dmesg|...}`,
  allowed passwordless by /etc/sudoers.d/labctl.
